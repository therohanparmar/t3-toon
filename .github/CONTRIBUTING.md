...
* Submit a ticket for your [issue](https://github.com/therohanparmar/t3-toon/issues), assuming one does not already exist.
...
* Use `composer test:unit` to make sure the tests pass.
...
If `docker` is not available on your machine you can't run this command.

## Additional resources

* [Rendered documentation](https://docs.typo3.org/p/rrp/t3-toon/main/en-us/)
